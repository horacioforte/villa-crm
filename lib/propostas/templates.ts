...
export const PROPOSTA_TEMPLATES = [
  ...
  },
  {
    ...
    descricao:
      "Template oficial CBSO extraído da minuta padrão aprovada pelo comercial.",
    disponivel: true,
    escopo: [
    ...
    observacoesTecnicasPadrao:
      "Os equipamentos devem ser operados pela Locatária conforme manual, checklist e responsabilidades previstas na minuta oficial.",
    condicoesPagamentoPadrao:
      "Medição mensal, faturamento após aprovação e boleto com vencimento em até 25 dias, sujeito à aprovação cadastral financeira.",
    defaults: {
    ...
    blocos: [
      ...
      bloco(30, "responsabilidade_locadora", "2. Responsabilidade da Locadora", "BLOQUEADO", [
        ...
        "*Não é permitido colocar nenhum tipo de adesivo que obstrua ou dificulte as identificações da Villa Empreendimentos {{nos_equipamentos}}, seja total ou parcial*",
        "O implemento betoneira possui capacidade máxima de 8 m3, devendo a Locatária respeitar rigorosamente os limites de peso estabelecidos pelo fabricante e pela legislação de trânsito vigente, especialmente quanto ao peso bruto total e peso por eixo em fiscalizações de balança rodoviária, considerando que o peso do metro cúbico de concreto pode variar conforme sua composição;",
        "Todas as multas, autuações ou penalidades de trânsito, incluindo aquelas decorrentes de excesso de peso, excesso por eixo ou irregularidades na circulação dos veículos, serão de inteira responsabilidade da Locatária, que também deverá realizar a identificação do condutor junto aos órgãos competentes, isentando a Locadora de qualquer responsabilidade durante o período da locação;",
        "Garantia por equipamento é de 180 horas/mês (horímetro);",
        "Obs.: A disponibilidade contratada considera {{os_equipamentos}} e o que ultrapassar as 180 horas/mês (horímetro) será cobrado como horas excedentes;",
        "O estado de conservação {{dos_equipamentos}} será verificado através de um Termo de Vistoria/Checklist composto por fotografias e descrições detalhadas, o qual será assinado por ambas as partes, antecedente a retirada {{dos_equipamentos}} na sede da Locadora;",
        "A Locatária reconhece o recebimento {{dos_equipamentos}} em perfeito estado de funcionamento, com vistoria devidamente realizada e aptidão técnica para a finalidade contratada. Assim, qualquer perda de concreto, inutilizações de concreto transportado {{nos_equipamentos}}, incluindo, mas não se limitando a problemas relacionados a slump inadequado, traço incorreto, desagregação, desargamassado, concreto vencido ou qualquer outro fator técnico que venha a comprometer a integridade do material ainda que decorrente de eventual falha mecânica de algum equipamento durante o transporte ou a concretagem, será de inteira e exclusiva responsabilidade da Locatária;",
        "Impostos inclusos referentes às locações {{dos_equipamentos}};",
        "A Locadora assumirá custos com pneus dentro das seguintes regras: A vida útil de um pneu para uso fora da estrada é aproximadamente 80.000km sendo 40.000km para primeira vida e 40.000km para as duas outras coberturas de vidas, em caso de pneus rasgados ou danificados por impacto, será responsabilidade da Locatária. Todos os pneus são marcados e catalogados existindo um acompanhamento de suas vidas úteis;",
        "A Locadora assumirá o custo com molas quebradas dentro do tempo de vida útil de 06 (seis) meses para arqueamento. Molas quebradas e ou danificadas fora deste critério, será de total responsabilidade da Locatária;",
      ...
      bloco(60, "observacoes_preco", "Observações de preço", "EDITAVEL_COM_APROVACAO", [
        "Obs.01: Caso as horas garantidas no período mensal não sejam atingidas, a Locatária obriga-se a realizar o pagamento do valor integral da franquia mensal, conforme acordado na tabela constante do item 4 acima.",
        "Obs.02: A retirada e o transporte {{dos_equipamentos}} são de responsabilidade da Locatária. Isso inclui todos os deslocamentos {{dos_equipamentos}}, bem como a mobilização e desmobilização, tendo como ponto de partida a base da Locadora, localizada em Bezerros-PE.",
        "Obs.03: Caso as 180 horas mínimas sejam ultrapassadas, a Locatária deverá pagar, além da franquia acordada, o valor proporcional às horas excedentes, no montante de R$ 166,67 (cento e sessenta e seis reais e sessenta e sete centavos) por hora.",
        "Obs.04: Não será concedido nenhum tipo de desconto na locação {{dos_equipamentos}} da Contratada por dias parados devido a períodos festivos, feriados ou recessos indicados pela Contratante.",
        "Obs.05: A Locadora declara que não disponibiliza seguros {{dos_equipamentos}}. No entanto, caso haja interesse da Locatária, a Locadora poderá realizar a cotação do seguro correspondente e repassar o respectivo custo na medição mensal acrescido dos seus impostos, desde que previamente aprovado pela Locatária.",
        "Obs.06: Para fins de cálculo proporcional de valores, considera-se o mês como composto por 30 (trinta) dias corridos, independentemente do número real de dias no mês.",
      ]),
      bloco(70, "prazo_duracao", "5. Prazo para inicialização e 6. Duração do contrato", "EDITAVEL_COM_APROVACAO", [
        "5. Prazo para inicialização do contrato:",
        "A retirada poderá ser programada para sair da Matriz da Locadora, em até 72 (setenta e duas) horas após a sua solicitação formal via e-mail, a contar da assinatura desta proposta, pois ela tem valor de pré-contrato até a assinatura do contrato;",
        "O contrato começa a prevalecer na saída {{dos_equipamentos}} na sede da Locadora;",
        "6. Duração do Contrato:",
        "O contrato terá duração mínima de 03 (três) meses, podendo ser renovado por um período maior, de acordo com a necessidade da Locatária;",
        "Na hipótese de a Locatária solicitar a desmobilização {{dos_equipamentos}} antes do término do prazo mínimo de 03 (três) meses, será obrigada a pagar, a título de multa compensatória, o valor correspondente à franquia mínima de 03 (três) meses, independentemente do período efetivamente utilizado;",
        "Independente se a devolução {{dos_equipamentos}} esteja ou não no prazo vigente do contrato, a Locatária deverá informar a Locadora com um prazo mínimo de 15 (quinze) dias, para devolução {{dos_equipamentos}} hora locados, para que a mesma possa proceder com os trâmites de recebimento. A falta desta informação acarretará a cobrança da diferença dos dias acima mencionados;",
        "A Locatária será responsável pela devolução {{dos_equipamentos}} na sede da Locadora, como já mencionado anteriormente, em data previamente acordada, nas mesmas condições de uso e conservação de acordo com o checklist de retirada, conforme previsto nas demais cláusulas contratuais;",
      ]),
      bloco(80, "contrato_pagamento", "7. Elaboração do contrato e 8. Medição, faturamento e pagamento", "EDITAVEL_COM_APROVACAO", [
        "7. Elaboração do Contrato:",
        "Será feito 01 contrato de locação de equipamentos que representa 100% (cem por cento) do faturamento;",
        "Esta proposta tem caráter de pré-contrato, garantindo que os serviços realizados possam ser medidos e faturados mensalmente, onde as faturas deverão ser pagas nos seus respectivos vencimentos, mesmo que o contrato definitivo ainda esteja em processo de assinatura ou em análise;",
        "Poderá o presente instrumento ser rescindido por qualquer uma das partes, em qualquer momento, respeitando os 03 (três) meses mínimos de contrato, sem que haja qualquer tipo de motivo relevante, mediante simples e expressa comunicação prévia, no prazo de 15 (quinze) dias de antecedência, sempre formalizado via e-mail;",
        "8. Medição, Faturamento e Pagamento:",
        "Os serviços executados serão medidos no período do dia 1° ao último dia do mês anterior ao mês em que será efetuado o pagamento;",
        "No primeiro dia útil subsequente aos 30 (trinta) dias de utilização {{dos_equipamentos}} ora locados, a Locadora irá emitir, então, o Boletim de Medição, onde constará o total da medição do mês vencido, devendo, ato contínuo, no mesmo dia enviá-la para a Locatária, a qual, por sua vez, terá o prazo máximo de 5 (cinco) dias corridos, contados do seu recebimento, para sua aprovação;",
        "Após a aprovação prevista no item anterior, seja de forma expressa ou tácita, caso a Locatária não aprove o Boletim de Medição dentro do prazo estabelecido, a Locadora deverá emitir e enviar à Locatária a fatura correspondente à locação, juntamente com o boleto bancário, com vencimento em até 25 (vinte e cinco) dias;",
        "Obs.: condições de faturamento acima indicadas estão sujeitas à aprovação do cadastro financeiro.",
        "Caso as faturas tenham sido emitidas com incorreções ou em desacordo com a legislação vigente serão devolvidas e o prazo para pagamento será o mesmo indicado nos pontos acima;",
        "A impontualidade no pagamento sujeitará a Locatária ao pagamento de juros de mora à razão de 1% (um por cento) ao mês, multa de 2% (dois por cento) após o 1º (primeiro) dia corrido do vencimento, independente da correção monetária e das demais sanções previstas em Lei e no presente contrato, aplicáveis às hipóteses de inadimplente;",
        "Obs.: Serão aplicadas todas as penalidades previstas na cláusula acima, caso as faturas não sejam aceitas sem motivo justo pela Locatária.",
        "Qualquer eventual tolerância da Locadora no recebimento das faturas, fora do prazo pactuado, não constituirá novação nem, tampouco, servirá para alegação de existência de precedente para repetição do fato tolerado;",
        "Caso a Locatária não realize o pagamento na data do seu vencimento corrente, após o prazo de 48 (quarenta e oito) horas do vencimento da fatura, a Locadora poderá paralisar a operação {{dos_equipamentos}} locados, sem que ocorra qualquer tipo de penalidade, independente de prévia notificação, e o período será contabilizado com {{os_equipamentos}} à disposição até a regularização da pendência;",
        "Caso a Locatária se torne inadimplente por período superior a 15 (quinze) dias, contados a partir do vencimento da fatura correspondente, a Locadora poderá rescindir o presente contrato, a seu exclusivo critério, sem necessidade de notificação adicional. Nessa hipótese, a Locatária será responsável pelo pagamento imediato de todas as parcelas em atraso, devidamente corrigidas e atualizadas, incluindo multas e eventuais perdas e danos previstos neste contrato. A Locatária deverá devolver {{os_equipamentos}} no prazo máximo de 05 (cinco) dias úteis, considerando o tempo necessário para organização das desmobilizações. Caso a devolução não ocorra dentro do prazo estipulado, a Locadora estará autorizada a recolher {{os_equipamentos}} no canteiro de obras da Locatária, que desde já se declara livre e desimpedida para a retirada. Todos os custos decorrentes da remoção, transporte e logística {{dos_equipamentos}} serão de responsabilidade exclusiva da Locatária, devendo ser pagos de imediato após a conclusão da retirada;",
      ]),
      bloco(90, "reajuste_validade", "9. Reajustes e 10. Validade da proposta", "EDITAVEL_COM_APROVACAO", [
        "9. Reajustes:",
        "Os preços estabelecidos nesta proposta serão reajustados semestralmente, com base nos índices de reajustes da construção civil que melhor se adequarem à locação de acordo com a FGV (Fundação Getúlio Vargas);",
        "Na ocorrência de fatos ou hipóteses não previstas nem disciplinadas neste documento, na ausência de um contrato selado posteriormente, as partes se reportarão ao que a respeito dispõe a legislação civil e comercial brasileira aplicável à espécie;",
        "10. Validade da proposta:",
        "A proposta terá validade de {{validade}};",
      ]),
