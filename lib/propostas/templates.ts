...
export const PROPOSTA_TEMPLATES = [
  {
    ...
    blocos: [
      ...
      bloco(50, "responsabilidade_contratante", "3. Responsabilidade da Contratante", "BLOQUEADO", [
        ...
        "Garantir acessos em bom estado de conservação para tráfego {{dos_equipamentos}}. Danos a pneus e molas causados por má qualidade dos acessos, bem como horas paradas para conserto, serão de responsabilidade da Contratante.",
        ...
        "Toda e qualquer quebra deverá ser solicitada por e-mail às áreas Comercial, Logística e Operação da Villa Empreendimentos.",
      ...
      bloco(70, "observacoes_preco", "Observações de preço e horas extras", "EDITAVEL_COM_APROVACAO", [
        ...
        "Hora extra: Caminhão betoneira/operador - R$ 225,00.",
  ...
  },
  {
    ...
    blocos: [
      ...
      bloco(30, "responsabilidade_locadora", "2. Responsabilidade da Locadora", "BLOQUEADO", [
        ...
        "Treinamento basico e orientacao tecnica da operacao {{dos_equipamentos}};",
      ]),
      bloco(40, "responsabilidade_locataria", "3. Responsabilidade da Locatária", "BLOQUEADO", [
        "Devolucao {{dos_equipamentos}} - A Locataria devera devolver {{os_equipamentos}} nas mesmas condicoes em que foram recebidos, conforme registrado no check-list de entrega, especialmente quanto a residuos de concreto e avarias. A Locataria sera integral e exclusivamente responsavel por quaisquer danos {{aos_equipamentos}}, incluindo tombamento, perda total, avarias decorrentes de acidentes, ou qualquer outra situacao similar, considerando que nao ha seguro para {{os_equipamentos}}. Ademais, a Locataria reconhece e aceita ser exclusivamente responsavel por quaisquer acidentes, danos materiais ou morais, lucros cessantes, prejuizos diretos ou indiretos que venham a ocorrer durante a vigencia deste contrato, seja contra {{os_equipamentos}} da Locadora, contra terceiros ou contra pessoas fisicas, em razao da operacao {{dos_equipamentos}} por seus funcionarios, prepostos ou quaisquer pessoas indicadas por ela. Todos os custos decorrentes dessas ocorrencias, incluindo reparo, substituicao, transporte e eventuais indenizacoes, serao de responsabilidade exclusiva da Locataria;",
        ...
        "Disponibilizar mao de obra qualificada para operacao {{dos_equipamentos}};",
        "Disponibilizar bons acessos ou caminhos de servico em boas condicoes de transito e seguranca como tambem controlar as velocidades {{dos_equipamentos}};",
        "Utilizar {{os_equipamentos}} exclusivamente para os fins a que se destinam, observando rigorosamente as orientacoes constantes no manual do fabricante. Fica expressamente proibido o reboque ou tracao {{dos_equipamentos}} por outros veiculos ou maquinas, tais como tratores;",
        ...
        "A Locataria devera responsabilizar-se integralmente pela guarda e seguranca {{dos_equipamentos}}, mantendo-{{os_pronome}} em local seguro, com controle de acesso, vigilancia e, sempre que possivel, monitoramento eletronico. Durante todo o periodo da locacao, a Locataria sera responsavel por qualquer ocorrencia de roubo, furto, tentativa de furto, vandalismo, desaparecimento ou dano {{aos_equipamentos}}, inclusive quanto a pequenos furtos de componentes ou acessorios, tais como, mas nao se limitando a baterias, pneus (inclusive estepe), macaco, triangulo, ferramentas, equipamentos de apoio ou quaisquer itens que integrem ou acompanhem o caminhao. Em qualquer dessas hipoteses, cabera exclusivamente a Locataria providenciar a imediata reposicao ou indenizacao correspondente, isentando a Locadora de qualquer responsabilidade sobre tais ocorrencias durante o periodo da locacao.",
        "A responsabilidade tecnica, civil e penal pelos servicos executados com {{os_equipamentos}};",
        "Manutencao Corretiva - A Locataria sera responsavel pela execucao integral da manutencao corretiva {{dos_equipamentos}} locados independente da causa da falha, incluindo substituicao de pecas, mao de obra, transporte e custos decorrentes do tempo de paralisacao, em razao de ser a responsavel direta pela operacao {{dos_equipamentos}}. A peca danificada devera ser removida pela Locataria e enviada, sob ciencia da Locadora, para analise tecnica do fabricante, cujo laudo sera vinculante para definicao da responsabilidade:",
  ...
  },
  {
    ...
    blocos: [
      ...
      bloco(40, "responsabilidade_contratante", "3. Responsabilidade da Contratante", "BLOQUEADO", [
        ...
        "Toda quebra deverá ser solicitada por e-mail às áreas Comercial, Logística e Operação da Villa Empreendimentos.",
        "O atendimento às solicitações deverá ocorrer em até 24 horas do recebimento da comunicação. A partir da chegada do técnico ou mecânico, a Contratada terá até 72 horas para reparo ou substituição sem desconto; ultrapassado esse prazo, o tempo excedente será descontado proporcionalmente.",
        "Reparos poderão ocorrer na obra, em unidade da Contratante ou em unidade da Contratada, quando necessária estrutura mais adequada.",
        "A Contratante deverá assinar controles de bombeamento/transporte de concreto (mapas diários) no dia seguinte ao trabalho/disposição. A falta de assinatura poderá interromper os trabalhos e somente esses mapas terão validade para medição.",
      ]),
