...
export const PROPOSTA_TEMPLATES = [
  {
    ...
    blocos: [
      ...
      bloco(30, "objeto", "1. Objeto", "BLOQUEADO", [
        "Fornecimento de CAMINHÕES BETONEIRAS, para prestação de serviço mensal.",
      ]),
      bloco(40, "responsabilidade_contratada", "2. Responsabilidade da Contratada", "BLOQUEADO", [
        "Caminhões betoneiras com capacidade de 8m3, da marca Schwing ou similar.",
        ...
        "Operador para 1 (um) turno de trabalho e equipamento: segunda a quinta das 07h00 às 17h00, com intervalo de 1h para refeição; sexta das 07h00 às 16h00, com intervalo de 1h para refeição.",
        "Após o turno estabelecido, sábado, domingo e feriado serão cobrados como extra.",
        "Impostos inclusos referentes à locação dos equipamentos.",
      ...
      bloco(50, "responsabilidade_contratante", "3. Responsabilidade da Contratante", "BLOQUEADO", [
        "Durante a vigência do contrato, a Contratante assume integral responsabilidade pela guarda e segurança dos equipamentos, protegendo-os contra ação danosa de terceiros e por prejuízos causados a terceiros, pessoas ou bens, por uso inadequado, imperícia, imprudência ou dolo.",
        "Garantir acessos em bom estado de conservação para tráfego dos equipamentos. Danos a pneus e molas causados por má qualidade dos acessos, bem como horas paradas para conserto, serão de responsabilidade da Contratante.",
        "Fiscalizar as velocidades dos equipamentos no canteiro ou vias de acesso, principalmente controles semanais dos tacógrafos, assumindo custos decorrentes de acidentes com excesso de velocidade.",
        ...
        "Disponibilizar local adequado para limpeza diária dos equipamentos, observando normas técnicas e ambientais brasileiras. Multas, autuações ou não conformidades serão de responsabilidade da Contratante.",
        ...
        "Devolver os equipamentos nas mesmas condições em que foram recebidos e documentados no checklist de entrega, principalmente quanto a resíduos de concreto e avarias.",
      ]),
      ...
      bloco(80, "prazo_duracao", "5. Prazo para inicialização e 6. Duração do contrato", "EDITAVEL_COM_APROVACAO", [
        ...
        "Caso a devolução dos equipamentos ocorra antes do período mínimo, as mensalidades restantes serão pagas integralmente sem abatimento até a data da efetiva devolução.",
