// ARQUIVO: app/inteligencia/maria/page.tsx
// REGRA: nunca remover. Apenas acrescentar.
// Aba Maria dentro do Centro de Inteligência (/inteligencia/maria).
// Mesmo conteúdo de /maria/page.tsx, sem PageNavigation — usa o layout do Centro de Inteligência.
...
export default async function MariaInteligenciaPage() {
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-[#F4F6FA] px-5 py-8 text-[#172033] sm:px-8">
