...
// Facebook ainda não está ativo nesta fase — apenas preparado
// arquiteturalmente (aba, rota, RedeSocialConta) conforme escopo da Sprint 1.
export default function MidiasSociaisFacebookPage() {
  return (
    <div>
      <header>
        ...
        <h1 className="mt-2 text-3xl font-bold text-[#1A2E5A]">Facebook</h1>
      </header>
      ...
      <div className="mt-6 flex flex-col items-center justify-center gap-3 rounded-3xl border border-dashed border-[#D7DEEA] bg-white px-6 py-16 text-center">
        <ThumbsUp className="size-10 text-[#D7DEEA]" />
        ...
        <p className="max-w-md text-sm text-[#667085]">
          A estrutura para o Facebook já está preparada arquiteturalmente na Central de Mídias
